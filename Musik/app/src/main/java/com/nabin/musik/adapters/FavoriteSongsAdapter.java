...
public class FavoriteSongsAdapter extends RecyclerView.Adapter<FavoriteSongsAdapter.FavoriteSongViewHolder> {
    ...
    public static ArrayList<SongModel> favoriteSongs = new ArrayList<>();
    private final Context context;
    private final SongListRecyclerViewItemClick mSongListRecyclerViewItemClick;

    public FavoriteSongsAdapter(ArrayList<SongModel> mSongs, Context context, SongListRecyclerViewItemClick mSongListRecyclerViewItemClick) {
        favoriteSongs = mSongs;
    ...
    public FavoriteSongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavoriteSongViewHolder(view, mSongListRecyclerViewItemClick);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteSongViewHolder holder, int position) {
        holder.songName.setText(favoriteSongs.get(position).getSongName());
        holder.songArtist.setText(favoriteSongs.get(position).getArtistName());
        holder.songDuration.setText(formattedSecs(Integer.parseInt(favoriteSongs.get(position).getSongDuration())) + " min");
        Uri uri = Uri.parse(favoriteSongs.get(position).getImagePath());
    ...
    public static class FavoriteSongViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public FavoriteSongViewHolder(@NonNull View itemView, SongListRecyclerViewItemClick mSongListRecyclerViewItemClick) {
            super(itemView);
    ...
    public void updateSongs(ArrayList<SongModel> songsList) {
        ...
        favoriteSongs.addAll(songsList);
